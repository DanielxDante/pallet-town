<script lang="ts">
	...
	function downloadFile() {
		...
		link.download = 'daniel_tay_resume.pdf';
...
<section id="landing" class="flex flex-col items-center justify-center h-full py-10 border-b-2 border-dashed">
	<Canvas>
		<Scene />
	</Canvas>
...
<section id="about" class="scroll-mt-16 flex flex-col items-left justify-center h-full py-10 border-b-2 border-dashed">
	...
	<p class="text-lg py-3 text-justify" style="font-family: 'Neue Montreal'">
		I am currently an AI Software Developer at <span style="color:rgb(103, 232, 249)">SAP Labs</span>, working in the ___ team under AI Business Services.
			...
			{#if experiences[selectedExperience]}
				<div class="mb-4">
					...
					<div class="text-sm opacity-75 mb-4" style="font-family: 'Neue Montreal'">
						{experiences[selectedExperience].period} | {experiences[selectedExperience].location}
					</div>
				</div>
